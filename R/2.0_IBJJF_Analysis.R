...
# Before starting analysis my hypothesis is the following:
...
# point, where you simply become to small. I generally believe that being larger and heavier increases you chances of winning or placing in the absolute.

# High Level Analysis ####
# First look at what does the data say in general?

# Remove NA records for analysis.
...
# Does the tournament play a role at all in who can place in the absolute, perhaps in Brazil where the sport is very mature it's mostly heavier competitors.
...
# 200 competitors who took 2nd in their weight class made the absolute podium. etc… Will do in the future.
