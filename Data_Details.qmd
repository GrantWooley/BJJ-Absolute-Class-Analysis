...
![Beginning of a berimbolo sequence in a Gi competition.](img/bjj_gi.jpg){fig-align="center" width="875"} **No-Gi Jiu Jitsu** - In No-Gi Jiu Jitsu spandex clothing is worn consisting of a rashguard (top), shorts, and sometimes spats (tights). In No-Gi gripping of the uniform is not allowed. No-Gi is considred faster and more dynamic than Gi Jiu Jitsu, has a wider range of legal submissions (leglocks), and is more heavily influenced by [Wrestling](Wrestling) than Gi Jiu Jitsu.
